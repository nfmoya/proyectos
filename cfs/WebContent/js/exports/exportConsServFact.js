 ...
 */ 
function exportDataGridToHtmlSF(title, grid,fileType){
	...
	/*--------------------------------------------------------------------------------------------------------*/
	 ...
	 /*--------------------------------------------------------------------------------------------------------*/
		...
		var htmlFilter = getFiltrosToHtmlSF('Filtros de Busqueda');
 ...
 * @returns {String}
 */
function getFiltrosToHtmlSF(titleFilter){
...
//   '<caption >'+ titleFilter +'</caption><tr>'+
   ...
   gridEnc += 	'<tr>'+
              	...
              	'<td colspan="14" style="text-align: left">'+$('#selectedGrupo option:selected').text() +'</td>'+
              	'</tr>';
   gridEnc += 	'<tr>'+
              	'<td colspan="2">Activado</td>'+
              	'<td colspan="14">'+ $('#habilitadoSel option:selected').text() +'</td>'+
              	'</tr>';
   gridEnc += 	'<tr>'+
				'<td colspan="2">Periodo Fact. Desde</td>'+
				'<td colspan="14">'+ $('#fhDesde option:selected').text() +'</td>'+
				'</tr>';
   gridEnc += 	'<tr>'+
				'<td colspan="2">Peroido act. Hasta</td>'+
				'<td colspan="14">'+ $('#fhHasta option:selected').text() +'</td>'+
				'</tr>';
   gridEnc += 	'<tr>'+
				'<td colspan="2">Tipo Comprobante</td>'+
				'<td colspan="14">'+ $('#selectedComp option:selected').text() +'</td>'+
				'</tr>';
   gridEnc += 	'<tr>'+
				'<td colspan="2">Nro Comprobante</td>'+
				'<td colspan="14">'+ $('#cdComprobante').val() +'</td>'+
				'</tr>';
   gridEnc += 	'<tr>'+
				'<td colspan="2">Remito Desde</td>'+
				'<td colspan="14">'+ $('#remitoDesde option:selected').text() +'</td>'+
				'</tr>';
   gridEnc += 	'<tr>'+
				'<td colspan="2">Remito Hasta</td>'+
				'<td colspan="14">'+ $('#remitoHasta option:selected').text() +'</td>'+
				'</tr>';
   gridEnc += 	'<tr>'+
