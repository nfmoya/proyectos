...
<html:form action="/ConsServFact">
	...
	<fieldset id="conServFactFilter" class="ui-widget ui-widget-content ui-corner-all" style="width:1052px;">
		<legend id="conServFact_filter_legend"
			class="ui-widget ui-widget-header ui-corner-all"> Detalle de Servicios Facturados </legend>

		<div class="fila" id="conServFact_responseMsgs"	style="display: none; overflow: auto;"></div>
			...
			<div class="fila" style="height: 10px;" id="filaProducto">
				...
				<div class="col_input" style="width: 260px; margin-left: 10px;">
					<html:select property="selectedProducto" name="servFactForm"
						...
						<html:optionsCollection name="servFactForm"
							property="filtroProductoList" label="desc" value="cod" />
					</html:select>
				</div>
				<div class="col_label" style="width: 140px;">Unidad
					Valoraci&oacute;n:</div>
		...
		<fieldset id="conServFactOther"
			...
			<button id="btnSummary" type="button" >Resumen</button>
...
<script type="text/javascript" src="js/consultas/consServFactDet.js"></script>
